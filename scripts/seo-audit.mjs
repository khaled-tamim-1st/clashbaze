...
const routesToAudit = [
  ...
  },
  {
    ...
    type: "category",
    expectedH1: "حسابات كلاش أوف كلانس للبيع",
    expectedTitle: "حسابات كلاش أوف كلانس للبيع | متجر كلاش ماركت",
    expectedDesc: "اشترِ حسابات وقرى كلاش أوف كلانس (تاون هول 14 إلى 18) بتسليم يدوي مباشر وضمان وفق سياسة المتجر. كلاش ماركت — متجر حسابات كلاش في السعودية والخليج.",
