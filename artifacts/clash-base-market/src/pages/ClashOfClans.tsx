...
const cocFaqItems = [
  {
    ...
    answer: "اختر القرية المناسبة من القائمة، اضغط على زر الواتساب، ونتواصل معك مباشرة من إدارة المتجر لإتمام نقل ملكية Supercell ID وتغيير البريد الإلكتروني وتأمين الحساب برقمك خلال دقائق بأمان تام.",
  },
  {
    question: "هل حسابات كلاش أوف كلانس مضمونة ضد السحب؟",
    answer: "نعم، جميع الحسابات مملوكة ومفحوصة يدوياً ومشمولة بالضمان الذهبي الكامل ضد السحب والاسترجاع مدى الحياة، مع تسليم الإيميل الأساسي.",
  },
  {
