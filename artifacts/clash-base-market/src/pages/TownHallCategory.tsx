...
const TH_CONFIGS: Record<TownHallLevel, TownHallConfig> = {
  ...
  17: {
    level: 17,
    title: "حسابات كلاش أوف كلانس تاون هول 17 للبيع | قريات ماكس — كلاش ماركت",
  ...
  16: {
    level: 16,
    title: "حسابات كلاش أوف كلانس تاون هول 16 للبيع | قريات مميزة — كلاش ماركت",
  ...
  15: {
    level: 15,
    title: "حسابات كلاش أوف كلانس تاون هول 15 للبيع | أسعار مخفضة — كلاش ماركت",
