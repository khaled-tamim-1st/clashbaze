...
export const faqData = [
  ...
  },
  {
    ...
    answer:
      "يتم الاتفاق على وسيلة التحويل مباشرة مع وسيط المتجر عبر الواتساب، بما في ذلك التحويل البنكي المباشر للحسابات البنكية السعودية والخليجية بكل سهولة وأمان.",
  },
  {
    question: "هل الحسابات المعروضة في كلاش ماركت مضمونة؟",
    answer:
      "نعم، جميع الحسابات مفحوصة يدوياً ومشمولة بوثيقة الضمان الذهبي ضد السحب أو الاسترجاع مدى الحياة، مع تسليم الإيميل الأساسي النظيف.",
  },
  {
    question: "كم يستغرق تسليم الحساب بعد إتمام الدفع؟",
    answer:
      "التسليم يدوي ومباشر عبر الواتساب بإشراف الوسيط، حيث يستغرق عادةً من 5 إلى 15 دقيقة لإتمام نقل البريد وتأمين الحساب على جهازك خطوة بخطوة.",
  },
  {
