    ...
    <article class="prose" style="max-width: 850px; margin: 0 auto; line-height: 1.8;">
      ...
      <section style="background: #1e293b; border: 1px solid #334155; border-radius: 16px; padding: 28px; margin-bottom: 32px;">
        ...
        <p style="color: #cbd5e1; font-size: 1rem; margin-bottom: 24px;">
          يعمل وسيط كلاش ماركت المعتمد كطرف ضامن ومحايد؛ حيث لا يتم تحويل مستحقات البيع إلا بعد مراجعة سجل الحساب، والتأكد من عدم وجود تسجيلات دخول نشطة غير مصرح بها، واكتمال نقل بيانات البريد وربط هاتف المشتري بنجاح.
        </p>
        ...
        <div style="background: rgba(245, 158, 11, 0.1); border-right: 4px solid #f59e0b; padding: 16px; border-radius: 8px; color: #f8fafc; font-size: 0.95rem;">
          <strong>تنبيه للأمان:</strong> يوفر وسيط المتجر عبر الواتساب إرشاداً خطوة بخطوة أثناء التسليم لتفعيل الحماية برقم الجوال وأكواد الاسترداد لضمان أعلى مستويات الأمان.
        </div>
      </section>
...
router.get("/how-it-works", (req, res) => {
  ...
  const description =
    "تعرف على خطوات شراء واستلام حسابات كلاش أوف كلانس وكلاش رويال في كلاش ماركت. تسليم يدوي مباشر بإشراف وسيط معتمد عبر الواتساب.";
    ...
    breadcrumbJsonLd(breadcrumbs),
    {
      ...
      step: [
        ...
        },
        {
          ...
          text: "اضغط على زر شراء عبر الواتساب للتواصل مع الوسيط المعتمد وتأكيد توفر الحساب والاتفاق على طريقة الدفع.",
        },
        {
          "@type": "HowToStep",
          position: 3,
          name: "تحويل المبلغ بالاتفاق مع الوسيط",
          text: "يتم تحويل قيمة الحساب بالوسيلة المتفق عليها مباشرة مع الوسيط (مثل التحويل البنكي المباشر).",
        },
        {
          "@type": "HowToStep",
          position: 4,
          name: "نقل الحساب وتأمينه خطوة بخطوة",
          text: "يقوم الوسيط بتسليمك بيانات الإيميل الأساسي وربط الحساب ببياناتك وهاتفك الشخصي ومساعدتك في تأمينه.",
        },
      ],
    },
  ];
      ...
      <section style="display: flex; flex-direction: column; gap: 20px; margin-bottom: 40px;">
        ...
        <div style="background: #1e293b; border: 1px solid #334155; border-radius: 16px; padding: 24px; display: flex; gap: 20px; align-items: flex-start;">
          ...
          <div>
            ...
            <p style="color: #94a3b8; font-size: 0.95rem; margin: 0;">
              اضغط على زر <strong>"شراء عبر الواتساب"</strong> في صفحة الحساب، وسيقوم النظام بتوجيهك مباشرة لمحادثة الوسيط مع إرفاق تفاصيل الحساب لتأكيد توفره فوراً والاتفاق على طريقة التحويل.
            </p>
          </div>
        </div>
        ...
        <div style="background: #1e293b; border: 1px solid #334155; border-radius: 16px; padding: 24px; display: flex; gap: 20px; align-items: flex-start;">
          ...
          <div>
            <h2 style="font-size: 1.3rem; font-weight: 700; color: #f8fafc; margin-bottom: 6px;">تحويل المبلغ بالاتفاق مع الوسيط</h2>
            <p style="color: #94a3b8; font-size: 0.95rem; margin: 0;">
        ...
        <div style="background: #1e293b; border: 1px solid #334155; border-radius: 16px; padding: 24px; display: flex; gap: 20px; align-items: flex-start;">
          ...
          <div>
            ...
            <p style="color: #94a3b8; font-size: 0.95rem; margin: 0;">
              يقوم الوسيط معك في نفس اللحظة بتسليمك بيانات الإيميل الأساسي أو نقل بريد Supercell ID إلى بريدك الشخصي، ومساعدتك في تفعيل التحقق برقم هاتفك لضمان دخولك للقرية وخروج المالك السابق نهائياً.
            </p>
          </div>
        </div>
      </section>
