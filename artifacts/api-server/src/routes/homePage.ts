      ...
      },
      {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "يتم الاتفاق على وسيلة التحويل مباشرة مع وسيط المتجر عبر الواتساب، بما في ذلك التحويل البنكي المباشر للحسابات السعودية والخليجية بكل سهولة وأمان."
            }
          },
          {
            "@type": "Question",
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "نعم، جميع الحسابات مفحوصة يدوياً ومشمولة بوثيقة الضمان الذهبي ضد السحب أو الاسترجاع مدى الحياة، مع تسليم الإيميل الأساسي النظيف."
            }
          },
          {
            "@type": "Question",
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "التسليم يدوي ومباشر عبر الواتساب بإشراف الوسيط، حيث يستغرق عادةً من 5 إلى 15 دقيقة لإتمام نقل البريد وتأمين الحساب على جهازك خطوة بخطوة."
            }
          },
          {
            "@type": "Question",
    ...
    const bodyHtml = `
      ...
      <section style="margin: 48px 0; background: #1e293b; border: 1px solid #334155; border-radius: 12px; padding: 24px;">
        ...
        <ul style="color: #cbd5e1; padding-right: 20px; line-height: 2;">
          ...
          <li><strong>تحويل بنكي مباشر بالاتفاق:</strong> إمكانية التحويل البنكي لحسابات سعودية وخليجية دون تعقيد.</li>
          <li><strong>تسليم يدوي بإشراف وسيط:</strong> إتمام المعاملات خطوة بخطوة والتواصل المباشر عبر الواتساب.</li>
      ...
      <section style="margin: 48px 0; background: #1e293b; border: 1px solid #334155; border-radius: 12px; padding: 24px;">
        ...
        <div style="margin-top: 16px; border-bottom: 1px solid #334155; padding-bottom: 16px;">
          ...
          <p style="color: #cbd5e1; margin: 0;">يتم الاتفاق على وسيلة التحويل مباشرة مع وسيط المتجر عبر الواتساب، بما في ذلك التحويل البنكي المباشر للحسابات السعودية والخليجية بكل سهولة وأمان.</p>
        </div>

        <div style="margin-top: 16px; border-bottom: 1px solid #334155; padding-bottom: 16px;">
          <h3 style="font-size: 1.15rem; color: #f59e0b; margin-bottom: 8px;">س: هل الحسابات المعروضة في كلاش ماركت مضمونة؟</h3>
          <p style="color: #cbd5e1; margin: 0;">نعم، جميع الحسابات مفحوصة يدوياً ومشمولة بوثيقة الضمان الذهبي ضد السحب أو الاسترجاع مدى الحياة، مع تسليم الإيميل الأساسي النظيف.</p>
        </div>

        <div style="margin-top: 16px; border-bottom: 1px solid #334155; padding-bottom: 16px;">
          <h3 style="font-size: 1.15rem; color: #f59e0b; margin-bottom: 8px;">س: كم يستغرق تسليم الحساب بعد إتمام الدفع؟</h3>
          <p style="color: #cbd5e1; margin: 0;">التسليم يدوي ومباشر عبر الواتساب بإشراف الوسيط، حيث يستغرق عادةً من 5 إلى 15 دقيقة لإتمام نقل البريد وتأمين الحساب على جهازك خطوة بخطوة.</p>
        </div>
